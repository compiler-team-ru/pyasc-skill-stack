...
"""Kernel: reduce_sum along last axis for float32.

Row-wise sum reduction: [num_rows, num_cols] -> [num_rows]
Input shapes: [32, 4096], Output shape: [32]
Dtype: float32, Axis: -1 (last axis)
Tiling: row_per_core via asc2.range
Tail: host_pad (padding=8 element scalar pad)
Accumulator: float32
